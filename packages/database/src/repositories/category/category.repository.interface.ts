...
export interface ICategoryRepository {
  ...
  // addCoursesToCategory(categoryId: string, courseIds: string[]): Promise<Category>; // Relation table removed, update via Category
  // removeCoursesFromCategory(categoryId: string, courseIds: string[]): Promise<Category>; // Relation table removed, update via Category
