...
const TOAST_LIMIT = 3 // Tối đa 3 thông báo
const TOAST_REMOVE_DELAY = 10000 // 10 giây
...
function toast({ ...props }: Toast) {
  ...
  // Tự động tắt thông báo sau TOAST_REMOVE_DELAY ms
  const autoClose = setTimeout(() => {
    console.log('Tự động đóng toast sau 10 giây:', id);
    dismiss();
  }, TOAST_REMOVE_DELAY);
